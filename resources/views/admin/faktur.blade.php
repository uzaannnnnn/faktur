...
@section('content')
    <div x-data="{ modalOpen: false, modalData: {} }">
        <div class="space-y-6">
            <div>
                <h1 class="text-2xl font-semibold text-gray-900">Manajemen Faktur</h1>
                <p class="mt-1 text-sm text-gray-600">Lihat semua data faktur yang telah dibuat di dalam sistem.</p>
            </div>
                        ...
                        <tbody>
                            @forelse ($orders as $index => $order)
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="font-medium text-gray-800">{{ $order->nama_customer }}</div>
                                        <div class="text-xs text-gray-400">
                                            {{ $order->customer->alamat ?? 'Alamat tidak tersedia' }}</div>
                                    </td>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    <h3 class="text-lg leading-6 font-medium text-gray-900" id="modal-title">Konfirmasi Buat
                                        Nota Return</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Anda yakin ingin membuat nota return untuk faktur
                                            <strong x-text="modalData.no_faktur"></strong>? Tindakan ini akan memproses data
                                            return.
                                        </p>
                                    </div>
                                </div>
