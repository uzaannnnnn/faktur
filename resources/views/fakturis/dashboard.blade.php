@extends('layouts.app')
@section('content')
    <h3>Halo {{ Auth::user()->name }} as Fakturis 🙌</h3>
    <div class="main-content-wrap mt-5">

        <div class="wg-box">
            <div class="flex items-center justify-between gap10 flex-wrap">
                <a class="tf-button style-1 w208" href="add-faktur"><i class="icon-plus"></i>Buat Faktur</a>
            </div>
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">Belum ada faktur.</td>
                            </tr>
                        @endforelse
                    </tbody>
