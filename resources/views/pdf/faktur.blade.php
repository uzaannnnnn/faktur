...
<head>
    ...
    <style>
        /* Blok @font-face untuk Poppins telah dihapus */

        body {
            /* Menggunakan Helvetica/Arial sebagai font utama */
...
<body>
    <div class="footer">
        ...
        Faktur ini dicetak oleh sistem dan sah tanpa tanda tangan.
    </div>
        ...
        <table class="details">
            <tr>
                ...
                <td style="width: 50%; text-align: right;">
                    <strong>No. Faktur:</strong> {{ $order->no }}<br>
                    <strong>Tanggal:</strong>
                    {{ \Carbon\Carbon::parse($order->created_at)->isoFormat('DD MMMM YYYY') }}<br>
                    <strong>Pembayaran:</strong> {{ ucfirst($order->metode) }}
                </td>
            </tr>
        </table>
